...
const ForgotPassword = () => {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      const res = await API.post('/auth/verify-reset-otp', { email: formData.email, otp: formData.otp })
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const res = await API.post('/auth/reset-password', { email: formData.email, newPassword: formData.newPassword })
